...
export default function AboutUs() {
	...
	return (
		<Box component="span" sx={{ padding: 2 }}>
			...
			<img src={ufalLogo.src} className={styles.logo} />
			<img src={lindatLogo.src} className={styles.logo} />
			...
			<p>
				...
				<a href="https://ufal.mff.cuni.cz/martin-popel" target="_blank">Martin Popel</a>,&nbsp;
				<a href="https://ufal.mff.cuni.cz/jindrich-libovicky" target="_blank">Jindřich Libovický</a>,&nbsp;
				<a href="https://ufal.mff.cuni.cz/jindrich-helcl" target="_blank">Jindřich Helcl</a>,&nbsp;
				<a href="https://ufal.mff.cuni.cz/michal-novak" target="_blank">Michal Novák</a>,&nbsp;
				<a href="https://ufal.mff.cuni.cz/rudolf-rosa" target="_blank">Rudolf Rosa</a>,&nbsp;
				<a href="https://ufal.mff.cuni.cz/zdenek-kasner" target="_blank">Zdeněk Kasner</a>
			</p>

			<p>
				<b> Data preparation: </b>
				<a href="https://ufal.mff.cuni.cz/lucie-polakova" target="_blank">Lucie Poláková</a>,&nbsp;
				<a href="https://martin.majlis.cz" target="_blank">Martin Majliš</a>,&nbsp;
				Denys Bojko, Tomáš Musil, Tereza Chlaňová, Oxana Čmelíková, Martin Popel<br />
				Many thanks to <a href="https://wiki.korpus.cz/doku.php/en:cnk:intercorp" target="_blank">korpus.cz</a> for providing us with <b>InterCorp v14</b>, a part of the project Czech National Corpus.<br />
				We thank <a href="https://www.ceskepreklady.cz" target="_blank">České překlady</a> for cooperating on the project.
			</p>
			...
			<p>
				For any questions about this Translator, please contact <strong>u4u<img src={atChar.src} alt="@" style={{ height: ".8em" }}/>ufal.mff.cuni.cz</strong> .
			</p>
		</Box>
	);
}
